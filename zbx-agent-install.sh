...
wget https://github.com/nickchangs/zabbix-agent2/blob/master/ngx_status.sh -P /etc/zabbix/
wget https://github.com/nickchangs/zabbix-agent2/blob/master/access_status.sh -P /etc/zabbix/
wget https://github.com/nickchangs/zabbix-agent2/blob/master/ip_connection_count.sh -P /etc/zabbix/
wget https://github.com/nickchangs/zabbix-agent2/blob/master/zabbix_agentd.conf -P /etc/zabbix/
wget https://github.com/nickchangs/zabbix-agent2/blob/master/userparameter_nginx -P /etc/zabbix/zabbix_agentd.d/
